...
void create_new_root(Table* table, uint32_t right_child_page_num) {
    ...
    */
    ...
    /* Left child has data copied from old rood */
...
/*
Return the position of the given key. If the key is not present, return the position to where it should be inserted
*/
...
Pager* pager_open(const char* filename) {
    ...
    if(file_length % PAGE_SIZE != 0) {
        printf("Db file is not a whole number of pages. Curropt file.\n");
        exit(EXIT_FAILURE);
    }
